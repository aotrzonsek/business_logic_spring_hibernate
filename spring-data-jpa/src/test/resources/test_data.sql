...
insert into customer(id, email, birth_date, first_name, last_name, phone_number) values (2, 'customer2.gmail.pl', TO_DATE('1999/06/19', 'YYYY/MM/DD'), 'Janusz', 'Deweloperki', '324-556-499');
